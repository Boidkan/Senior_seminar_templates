...
In order to clarify, let $\alpha$ and $\beta$ be sections of code of two programs \texttt{A} and \texttt{B}, respectively, on which crossover is being applied. Semantic constraint checks for stack depth, variable type, and control flow were done to assure good crossover. The following is how these checks were done.\par
