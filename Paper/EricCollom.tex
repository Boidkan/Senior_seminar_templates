...
\section{Introduction}
	The ability of a computer to automatically solve problems is useful for fields such as artificial intelligence, machine learning~\cite{Nic:2008}, and software repair and debugging. A way in which accomplish this is by creating a program that evolves a program to solve a problem. This is called Genetic Programming, which is a tool of Evolutionary Computation (EC). The evolver program makes changes to program being evolved until either the desired problem is solved or until a specified number of changes has been made.\mycomment{I know its not about the number of changes but I still haven't introduced what generations are. Is this ok for the intro?}.\par
...
Section 2 covers the background needed to understand this paper. It contains information on Evolutionary Computation (EC), x86 assembly, and Java bytecode. Section 3 covers the reasons for evolving assembly and bytcode and its advantages over evolving source code. Section 4 discusses how Orlov, et al.,~\cite{FINCH:2011} program the FINCH works and evolves Java bytcode. In section 5 we will cover Eric, et al., similar work on both x86 assembly and Java bytecode.  
...
The FINCH is a program feveloped by Orlov et al., that evolves Java programs that are already compiled into bytecode.
