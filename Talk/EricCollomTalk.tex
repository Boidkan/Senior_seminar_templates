...
\section[Why]{Why Bytecode and Assembly?}
...
\item It is possible to evolve loops and recursion with instruction-level code
\item It is  fix bugs such as buffer overflows and incorrect type declaration
